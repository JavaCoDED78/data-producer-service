...
import com.javaded.DataProducerServiceApplication;
...
@SpringBootTest(
        classes = DataProducerServiceApplication.class,
    ...
    public void testSendPower() {
        ...
        Awaitility.await()
                ...
                .untilAsserted(() -> {
                    ...
                    assertTrue(ltr.names().get().contains("data-power"));
                    assertTrue(ltr.names().get().contains("data-voltage"));
                });
    }
